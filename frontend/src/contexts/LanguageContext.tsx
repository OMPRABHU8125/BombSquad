...
appTagline: {
  en: 'Your AI-powered crop disease detector for healthier farms',
  hi: 'स्वस्थ खेती के लिए AI से चलने वाला फसल रोग डिटेक्टर',
  te: 'ఆరోగ్యకరమైన వ్యవసాయం కోసం మీ AI-ఆధారిత పంట వ్యాధి గుర్తింపు',
  ta: 'ஆரோக்கியமான பண்ணைகளுக்கான உங்கள் AI-இயக்கப்படும் பயிர் நோய் கண்டறிதல்',
  kn: 'ಆರೋಗ್ಯಕರ ಕೃಷಿಗಾಗಿ ನಿಮ್ಮ AI-ಚಾಲಿತ ಬೆಳೆ ರೋಗ ಪತ್ತೆಕಾರ',
  mr: 'निरोगी शेतीसाठी तुमचा AI-आधारित पीक रोग शोधक'
},

instantAIDetection: {
  en: 'Instant AI Detection',
  hi: 'तुरंत AI पहचान',
  te: 'తక్షణ AI గుర్తింపు',
  ta: 'உடனடி AI கண்டறிதல்',
  kn: 'ತತ್ಕ್ಷಣ AI ಪತ್ತೆ',
  mr: 'त्वरित AI ओळख'
},

instantAIDetectionDesc: {
  en: 'Get disease identification in seconds using advanced machine learning',
  hi: 'उन्नत मशीन लर्निंग का उपयोग करके सेकंडों में रोग की पहचान करें',
  te: 'అధునాతన మెషిన్ లెర్నింగ్ ఉపయోగించి సెకన్లలో వ్యాధి గుర్తింపు పొందండి',
  ta: 'மேம்பட்ட இயந்திர கற்றலைப் பயன்படுத்தி வினாடிகளில் நோயை அடையாளம் காணுங்கள்',
  kn: 'ಸುಧಾರಿತ ಯಂತ್ರ ಕಲಿಕೆಯನ್ನು ಬಳಸಿಕೊಂಡು ಸೆಕೆಂಡುಗಳಲ್ಲಿ ರೋಗ ಗುರುತಿಸುವಿಕೆ ಪಡೆಯಿರಿ',
  mr: 'प्रगत मशीन लर्निंग वापरून सेकंदात रोगाची ओळख मिळवा'
},
...
expertRemedies: {
  ...
  hi: 'विशेषज्ञ उपाय',
  te: 'నిపుణుల నివారణలు',
  ta: 'நிபுணர் தீர்வுகள்',
  kn: 'ತಜ್ಞ ಪರಿಹಾರಗಳು',
  mr: 'तज्ञ उपाय'
},

expertRemediesDesc: {
  en: 'Access proven treatments and preventive measures for crop diseases',
  hi: 'फसल रोगों के लिए सिद्ध उपचार और रोकथाम के उपायों तक पहुंच',
  te: 'పంట వ్యాధుల కోసం నిరూపితమైన చికిత్సలు మరియు నివారణ చర్యలను యాక్సెస్ చేయండి',
  ta: 'பயிர் நோய்களுக்கான நிரூபிக்கப்பட்ட சிகிச்சைகள் மற்றும் தடுப்பு நடவடிக்கைகளை அணுகவும்',
  kn: 'ಬೆಳೆ ರೋಗಗಳಿಗೆ ಸಾಬೀತಾಗಿರುವ ಚಿಕಿತ್ಸೆಗಳು ಮತ್ತು ತಡೆಗಟ್ಟುವ ಕ್ರಮಗಳನ್ನು ಪ್ರವೇಶಿಸಿ',
  mr: 'पीक रोगांसाठी सिद्ध उपचार आणि प्रतिबंधात्मक उपायांचा वापर करा'
},

offlineCapable: {
  en: 'Offline Capable',
  hi: 'बिना इंटरनेट काम करे',
  te: 'ఆఫ్‌లైన్ సామర్థ్యం',
  ta: 'ஆஃப்லைன் திறன்',
  kn: 'ಆಫ್‌ಲೈನ್ ಸಾಮರ್ಥ್ಯ',
  mr: 'ऑफलाइन सक्षम'
},

offlineCapableDesc: {
  en: 'Works without internet connection for remote farming areas',
  hi: 'दूरदराज के खेती क्षेत्रों के लिए इंटरनेट कनेक्शन के बिना काम करता है',
  te: 'రిమోట్ వ్యవసాయ ప్రాంతాల కోసం ఇంటర్నెట్ కనెక్షన్ లేకుండా పనిచేస్తుంది',
  ta: 'தொலைதூர விவசாய பகுதிகளுக்கு இணைய இணைப்பு இல்லாமல் செயல்படும்',
  kn: 'ದೂರದ ಕೃಷಿ ಪ್ರದೇಶಗಳಿಗಾಗಿ ಇಂಟರ್ನೆಟ್ ಸಂಪರ್ಕವಿಲ್ಲದೆ ಕಾರ್ಯನಿರ್ವಹಿಸುತ್ತದೆ',
  mr: 'दूरस्थ शेती क्षेत्रांसाठी इंटरनेट कनेक्शनशिवाय कार्य करते'
},
...
signInSubtitle: {
  en: 'Sign in to start detecting crop diseases',
  hi: 'फसल रोगों का पता लगाना शुरू करने के लिए साइन इन करें',
  te: 'పంట వ్యాధులను గుర్తించడం ప్రారంభించడానికి సైన్ ఇన్ చేయండి',
  ta: 'பயிர் நோய்களைக் கண்டறிய உள்நுழையவும்',
  kn: 'ಬೆಳೆ ರೋಗಗಳನ್ನು ಪತ್ತೆಹಚ್ಚಲು ಸೈನ್ ಇನ್ ಮಾಡಿ',
  mr: 'पीक रोग शोधणे सुरू करण्यासाठी साइन इन करा'
},
...
byContinuing: {
  ...
  te: 'కొనసాగించడం ద్వారా, మీరు మా షరతులకు అంగీకరిస్తున్నారు',
  ta: 'தொடர்வதன் மூலம், நீங்கள் எங்கள் விதிமுறைகளுக்கு ஒப்புக்கொள்கிறீர்கள்',
  kn: 'ಮುಂದುವರಿಸುವ ಮೂಲಕ, ನೀವು ನಮ್ಮ ನಿಯಮಗಳನ್ನು ಒಪ್ಪುತ್ತೀರಿ',
  mr: 'सुरू ठेवून, तुम्ही आमच्या अटींशी सहमत आहात'
},
